...
insert into functional_parameters (technology, test_area, effective_routing, etest_name, parm_type_pcd) values
('TEST_TECH', 'TEST_AREA', 'TEST_ROUT', 'PARM1', 'WAS');
insert into functional_parameters (technology, test_area, effective_routing, etest_name, parm_type_pcd) values
('TEST_TECH', 'TEST_AREA', 'TEST_ROUT', 'PARM2', 'WAS');
insert into functional_parameters (technology, test_area, effective_routing, etest_name, parm_type_pcd) values
('TEST_TECH', 'TEST_AREA', 'TEST_ROUT', 'PARM3', 'WAS');
insert into functional_parameters (technology, test_area, effective_routing, etest_name, parm_type_pcd) values
('TEST_TECH', 'TEST_AREA', 'TEST_ROUT', 'PARM4', 'WAS');

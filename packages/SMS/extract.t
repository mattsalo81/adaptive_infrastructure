...
is(extract::get_COT($record), 'Y', "Identifying COT devices by product group");
my $record = {
	PROD_GRP	=>	'this is not a SEE OH TEE device',
};
is(extract::get_COT($record), 'N', "Identifying not-COT devices by product group");

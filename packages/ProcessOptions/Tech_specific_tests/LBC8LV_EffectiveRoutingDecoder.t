...
$codes = EffectiveRoutingDecoder::get_codes_from_routing("LBC8LV", "PARAMETRIC__M183+4B3L5");
...
$codes = EffectiveRoutingDecoder::get_codes_from_routing("LBC8LV", "PARAMETRIC__M180S4B5YB");
is(scalar @{$codes}, 6, "Correct number of codes returned");
is($codes->[0], "PARAMETRIC", "Correctly returns Test AREA");
is($codes->[1], "4", "Correctly returns number of metal levels");
is($codes->[2], "B", "Correctly Returns first char");
...
dies_ok(sub{$codes = EffectiveRoutingDecoder::get_codes_from_routing("LBC8LV", "TEST__M180-KISO4");}, "Unexpected LBC8LV format");

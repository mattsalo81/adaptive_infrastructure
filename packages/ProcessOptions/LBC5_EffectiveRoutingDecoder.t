...
is($codes->[0], "2", "Correctly returns #ML in test case");
is($codes->[1], "A+", "Correctly returns main code in test case");

$codes = EffectiveRoutingDecoder::get_codes_from_routing("LBC5", "A7.2F3AMMI");
is(scalar @{$codes}, 2, "Correct number of codes returned");
is($codes->[0], "3", "Correctly returns #ML in test case");
is($codes->[1], "AM", "Correctly returns main code in test case");

$codes = EffectiveRoutingDecoder::get_codes_from_routing("LBC5", "A70AI3N");
is(scalar @{$codes}, 2, "Correct number of codes returned");
is($codes->[0], "3", "Correctly returns #ML in test case");
is($codes->[1], "N", "Correctly returns main code in test case");

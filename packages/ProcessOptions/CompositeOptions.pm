...
sub get_composite_options_for_routing_and_effective_routing{
    ...
    my $primary = get_primary_options_for_routing_and_effective_routing($tech, $routing, $effective_routing);
    my $comp = get_composite_options_for_option_list($tech, $primary);
    return $comp;
}

sub get_primary_options_for_routing_and_effective_routing{
    my ($tech, $routing, $effective_routing) = @_;
    my ($eff_opt, $lpt_opt);
    eval{
